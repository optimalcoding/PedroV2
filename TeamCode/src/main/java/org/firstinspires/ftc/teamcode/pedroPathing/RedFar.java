...
public class RedFar extends OpMode {
    ...
    private final Pose startPose = new Pose(84.08447204968944, 8.178881987577643, Math.toRadians(90));
    private final Pose scorePose = new Pose(80.32795031055902, 13.99751552795031, Math.toRadians(130));
    private final Pose wait1 = new Pose(96.7751552795031,35.776397515527954,Math.toRadians(0));
    private final Pose pickup1Pose = new Pose(120.57888198757763,35.776397515527954,Math.toRadians(0));
/*    private final Pose wait2 = new Pose(96.7304347826087,59.19999999999996,Math.toRadians(0));
    ...
    */
    private final Pose leavePose = new Pose(98.53043478260871,14.60621118012422,Math.toRadians(0));
