...
public class RedClose extends OpMode {
    ...
    private final Pose startPose = new Pose(20.122.36521739130434, 121.09181141439203, Math.toRadians(45));
    private final Pose scorePose = new Pose(96.24844720496895, 95.85111662531017, Math.toRadians(45));
    private final Pose wait1 = new Pose(96.2919254658385,83.32506203473947,Math.toRadians(0));
    private final Pose pickup1Pose = new Pose(124.09192546583853,83.63027295285362,Math.toRadians(0));
    ...
    private final Pose leavePose = new Pose(123.79875776397516,71.46401985111663,Math.toRadians(0));
